# Khoaluantn: Codex + Codex Orchestration
...
**Architecture**: Codex (Orchestrator) + Codex (Worker)
...
Khoaluantn/
├── .Codex/
│   └── AGENTS.md (this file — orchestration logic)
│
├── src/
│   ├── orchestrator/     (Codex decision logic)
│   ├── shared/           (Types, utils, config)
│   └── integration/       (Codex ↔ Codex communication)
│
├── skills/
...
## ⚡ Quick Reference: When to use Codex vs Codex
...
3. **For Codex:** Run discovery skill or plan next phase
