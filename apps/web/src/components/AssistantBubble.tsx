...
import { getAssistantSession } from '../lib/assistantApi.js'

export function AssistantBubble() {
  const [open, setOpen] = useState(false); const trigger = useRef<HTMLButtonElement>(null); const session = getAssistantSession()
  if (!session?.roles.includes('player')) return null
