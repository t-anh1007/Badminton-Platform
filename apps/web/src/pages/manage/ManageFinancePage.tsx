...
export function ManageFinancePage() {
  ...
  const load = async () => {
    try {
      const [nextRevenue, nextWithdrawals] = await Promise.all([getMyRevenue(filters), getMyWithdrawals()])
