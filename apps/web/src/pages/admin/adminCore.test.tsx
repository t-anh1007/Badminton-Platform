...
import { lockAdminAccount } from '../../lib/accountApi.js'
import { cancelAdminBooking, rejectProvider } from '../../lib/venueBookingApi.js'
...
it('cancels a displayed booking without exposing its raw id as the label', async () => {
  ...
  expect(screen.getByText('Người chơi đặt sân · Mã tham chiếu u1')).toBeInTheDocument()
