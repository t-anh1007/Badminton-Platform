---
type: usecase-index
feature: nen-tang-cau-long
status: draft
updated: 2026-07-19
links:
  - docs/tai-khoan-va-quyen-truy-cap/usecases/tai-khoan-va-quyen-truy-cap-usecase-index.md
  - docs/nha-cung-cap-va-lich-san/usecases/nha-cung-cap-va-lich-san-usecase-index.md
  - docs/tim-san-va-booking/usecases/tim-san-va-booking-usecase-index.md
  - docs/tai-chinh-va-tranh-chap/usecases/tai-chinh-va-tranh-chap-usecase-index.md
  - docs/keo-va-player-passport/usecases/keo-va-player-passport-usecase-index.md
  - docs/community-va-cskh/usecases/community-va-cskh-usecase-index.md
...
|---:|---|---|---:|---|---|
| 1 | Tài khoản và quyền truy cập | `tai-khoan-va-quyen-truy-cap` | 9 | [[docs/tai-khoan-va-quyen-truy-cap/usecases/tai-khoan-va-quyen-truy-cap-usecase-index.md|Mở index]] | 1 |
| 2 | Nhà cung cấp và lịch sân | `nha-cung-cap-va-lich-san` | 13 | [[docs/nha-cung-cap-va-lich-san/usecases/nha-cung-cap-va-lich-san-usecase-index.md|Mở index]] | 1, 3 |
| 3 | Tìm sân và booking | `tim-san-va-booking` | 10 | [[docs/tim-san-va-booking/usecases/tim-san-va-booking-usecase-index.md|Mở index]] | 1 |
| 4 | Tài chính và tranh chấp | `tai-chinh-va-tranh-chap` | 14 | [[docs/tai-chinh-va-tranh-chap/usecases/tai-chinh-va-tranh-chap-usecase-index.md|Mở index]] | 1, 2, 3 |
| 5 | Kèo và Player Passport | `keo-va-player-passport` | 15 | [[docs/keo-va-player-passport/usecases/keo-va-player-passport-usecase-index.md|Mở index]] | 2, 3 |
| 6 | Cộng đồng và CSKH | `community-va-cskh` | 12 | [[docs/community-va-cskh/usecases/community-va-cskh-usecase-index.md|Mở index]] | 2 |
...
- Không chạy `$usecase-diagram --feature nen-tang-cau-long` vì index tổng thể có 79 Use Case và sẽ tạo sơ đồ không đọc được.
