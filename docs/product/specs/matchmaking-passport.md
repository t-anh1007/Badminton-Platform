...
| BR-MMP-06 | Chống chồng chỗ: tổng JOIN `approved` + `confirmed` + suất tổ chức ≤ `capacity`, kiểm ở tầng CSDL (ràng buộc/khóa), không chỉ tầng ứng dụng — tương tự chống double-booking GĐ1 (bất biến #4). |
