...
| D31 | 2026-08-23 | **Danh tính hồ sơ công khai:** nếu `visibility=public`, các bề mặt Header của chính chủ, Cộng đồng, Tìm kèo và Hộ chiếu công khai được dùng tên hiển thị và avatar thật; nếu `visibility=private`, mọi bề mặt công khai không được truyền tên thật hoặc URL avatar, dùng nhãn/avatar trung tính và `identityVisibility=hidden`. Bậc trình độ và dữ liệu kèo vẫn hiển thị. Header và trang hồ sơ của chính chủ luôn được xem danh tính của mình. **PO mở rộng quyết định 2026-08-23.** | ACC-07, MMP-03, MMP-09, COM-01, account-service, matchmaking-service, community-service |
